...
binary_operator!(add_u32, u32, |a, b| unsafe {
  core::intrinsics::unchecked_add(a, b)
});
binary_operator!(add_i32, i32, |a, b| unsafe {
  core::intrinsics::unchecked_add(a, b)
});

binary_operator!(sub_f32, f32, |a, b| a - b);
binary_operator!(sub_u32, u32, |a, b| unsafe {
  core::intrinsics::unchecked_sub(a, b)
});
binary_operator!(sub_i32, i32, |a, b| unsafe {
  core::intrinsics::unchecked_sub(a, b)
});

binary_operator!(mul_f32, f32, |a, b| a * b);
binary_operator!(mul_u32, u32, |a, b| unsafe {
  core::intrinsics::unchecked_mul(a, b)
});
binary_operator!(mul_i32, i32, |a, b| unsafe {
  core::intrinsics::unchecked_mul(a, b)
});

binary_operator!(div_f32, f32, |a, b| a / b);
binary_operator!(div_u32, u32, |a, b| unsafe {
  core::intrinsics::unchecked_div(a, b)
});
binary_operator!(div_i32, i32, |a, b| unsafe {
  core::intrinsics::unchecked_div(a, b)
});

binary_operator!(mod_f32, f32, |a, b| a % b);
binary_operator!(mod_u32, u32, |a, b| unsafe {
  core::intrinsics::unchecked_rem(a, b)
});
binary_operator!(mod_i32, i32, |a, b| unsafe {
  core::intrinsics::unchecked_rem(a, b)
});
